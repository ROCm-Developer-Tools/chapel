...
/**
 * A (naive) matrix multiply with RMO and CMO matrices. In each case, all three matrices are laid out
 * in the same order.  
 * 
 * The validation routine compares the RMO and  CMO outputs and prints "PASS" if the results match, 
 * "FAIL!" otherwise. . 
 *
 * Both MM operations are timed. On CPUs,  CMO achieves a speedup of ~1.6 over RMO
 * 
...
var X : [domColMajor] real; 
var Y : [domColMajor] real; 
var Z : [domColMajor] real; 
