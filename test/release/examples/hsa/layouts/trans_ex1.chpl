...
/**
 * Example showing the use of transposed layout using arrays of strings
 *
 * To validate results, build program as follows
 *    chpl -o trans --set chpl_dl_validate=true trans_ex1.chpl
 *
 * This will produced the following output for the transformed array. 
 * 
